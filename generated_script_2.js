...
function getMemberLoanLimit(m){ 
  ...
  function handleExitMemberChange(){
    ...
    var dispRd = document.getElementById("dispExitRd");
    var dispLoan = document.getElementById("dispExitLoan");
    var dispBonus = document.getElementById("dispExitBonus");
    var dispPen = document.getElementById("dispExitPen");
  ...
  function recalculateExitFinal(){
    ...
    var dispFinal = document.getElementById("dispExitFinal");
